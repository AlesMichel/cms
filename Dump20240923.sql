...
INSERT INTO `components` VALUES (1,'TextField','text'),(2,'Image','image');
...
INSERT INTO `module_components` VALUES (4,3,1,1,'','firstText');
...
INSERT INTO `modules` VALUES (3,'test','test');
...
--
-- Table structure for table `tset`
--
...
--
-- Dumping data for table `tset`
--

LOCK TABLES `tset` WRITE;
/*!40000 ALTER TABLE `tset` DISABLE KEYS */;
/*!40000 ALTER TABLE `tset` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-23 22:31:40
